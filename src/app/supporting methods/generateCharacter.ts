...
export function generateCharacter(
  ...
  console.log(selectedRace.raceName);
  const selectedSubrace = generateSubrace(selectedRace);
  const name = generateName(selectedSubrace);
  const alignment = generateAlignment(selectedRace, selectedSubrace);
  return null;
}

function generateName(selectedSubrace: any) {
    return "JEFF";
}
...
function generateSubrace(selectedRace: npcRace) {
...
function generateAlignment(selectedRace: npcRace, selectedSubrace: any) {
